          ...
          if (tasks.isEmpty) {
            return Center(
              child: Column(
                ...
                children: [
                  Icon(Icons.list, size: 64, color: Theme.of(context).colorScheme.onSurfaceVariant),
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Text('Are you sure you want to delete "${task.name}"? This will also delete all time entries for this task.'),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(context),
              child: const Text('Cancel'),
